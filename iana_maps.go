...
var IanaProtocol = map[uint8]string{
	0:   "ip",              // IPv4 encapsulation, pseudo protocol number
...
// Service Name and Transport Protocol Port Number Registry, Updated: 2018-02-21
var IanaPort = map[string]map[uint16]string{
	"tcp": {
		...
		63:    "whoispp",              // whois++ IANA assigned this well-formed service name as a replacement for "whois++".
		64:    "covia",                // Communications Integrator (CI)
		65:    "tacacs-ds",            // TACACS-Database Service
		66:    "sql-net",              // Oracle SQL*NET IANA assigned this well-formed service name as a replacement for "sql*net".
		...
		172:   "cl-1",                 // Network Innovations CL/1 IANA assigned this well-formed service name as a replacement for "cl/1".
		...
		210:   "z39-50",               // ANSI Z39.50 IANA assigned this well-formed service name as a replacement for "z39.50".
		211:   "914c-g",               // Texas Instruments 914C/G Terminal IANA assigned this well-formed service name as a replacement for "914c/g".
		212:   "anet",                 // ATEXSSTR
		213:   "ipx",                  // IPX
		...
		247:   "subntbcst-tftp",       // SUBNTBCST_TFTP IANA assigned this well-formed service name as a replacement for "subntbcst_tftp".
		248:   "bhfhs",                // bhfhs
		256:   "rap",                  // RAP
		...
		363:   "rsvp-tunnel",          // RSVP Tunnel IANA assigned this well-formed service name as a replacement for "rsvp_tunnel".
		...
		428:   "ocs-cmu",              // OCS_CMU IANA assigned this well-formed service name as a replacement for "ocs_cmu".
		429:   "ocs-amu",              // OCS_AMU IANA assigned this well-formed service name as a replacement for "ocs_amu".
		430:   "utmpsd",               // UTMPSD
		431:   "utmpcd",               // UTMPCD
		432:   "iasd",                 // IASD
		...
		625:   "dec-dlm",              // DEC DLM IANA assigned this well-formed service name as a replacement for "dec_dlm".
		626:   "asia",                 // ASIA
		...
		780:   "wpgs",                 // wpgs
		800:   "mdbs-daemon",          //  IANA assigned this well-formed service name as a replacement for "mdbs_daemon".
		801:   "device",               // device
		...
		887:   "iclcnet-svinfo",       // ICL coNETion server info IANA assigned this well-formed service name as a replacement for "iclcnet_svinfo".
		...
		1067:  "instl-boots",          // Installation Bootstrap Proto. Serv. IANA assigned this well-formed service name as a replacement for "instl_boots".
		1068:  "instl-bootc",          // Installation Bootstrap Proto. Cli. IANA assigned this well-formed service name as a replacement for "instl_bootc".
		...
		1138:  "encrypted-admin",      // encrypted admin requests IANA assigned this well-formed service name as a replacement for "encrypted_admin".
		...
		1313:  "bmc-patroldb",         // BMC_PATROLDB IANA assigned this well-formed service name as a replacement for "bmc_patroldb".
		...
		1382:  "udt-os",               // udt_os IANA assigned this well-formed service name as a replacement for "udt_os".
		1383:  "gwha",                 // GW Hannaway Network License Manager
		1384:  "os-licman",            // Objective Solutions License Manager
		1385:  "atex-elmd",            // Atex Publishing License Manager IANA assigned this well-formed service name as a replacement for "atex_elmd".
		...
		1415:  "dbstar",               // DBStar
		1416:  "novell-lu6-2",         // Novell LU6.2 IANA assigned this well-formed service name as a replacement for "novell-lu6.2".
		...
		1454:  "interhdl-elmd",        // interHDL License Manager IANA assigned this well-formed service name as a replacement for "interhdl_elmd".
		...
		1461:  "ibm-wrless-lan",       // IBM Wireless LAN IANA assigned this well-formed service name as a replacement for "ibm_wrless_lan".
		1462:  "world-lm",             // World License Manager
		1463:  "nucleus",              // Nucleus
		1464:  "msl-lmd",              // MSL License Manager IANA assigned this well-formed service name as a replacement for "msl_lmd".
		...
		1486:  "nms-topo-serv",        // nms_topo_serv IANA assigned this well-formed service name as a replacement for "nms_topo_serv".
		...
		1493:  "netmap-lm",            // netmap_lm IANA assigned this well-formed service name as a replacement for "netmap_lm".
		1494:  "ica",                  // ica
		1495:  "cvc",                  // cvc
		...
		1556:  "veritas-pbx",          // VERITAS Private Branch Exchange IANA assigned this well-formed service name as a replacement for "veritas_pbx".
		...
		1587:  "pra-elmd",             // pra_elmd IANA assigned this well-formed service name as a replacement for "pra_elmd".
		...
		1649:  "kermit",               // kermit
		1650:  "nkd",                  // nkdn
		1651:  "shiva-confsrvr",       // shiva_confsrvr IANA assigned this well-formed service name as a replacement for "shiva_confsrvr".
		1652:  "xnmp",                 // xnmp
		...
		2022:  "down",                 // down
		2023:  "xinuexpansion3",       // xinuexpansion3
		2024:  "xinuexpansion4",       // xinuexpansion4
		2025:  "ellpack",              // ellpack
		2026:  "scrabble",             // scrabble
		2027:  "shadowserver",         // shadowserver
		2028:  "submitserver",         // submitserver
		...
		2222:  "ethernet-ip-1",        // EtherNet/IP I/O IANA assigned this well-formed service name as a replacement for "EtherNet/IP-1".
		...
		2340:  "wrs-registry",         // WRS Registry IANA assigned this well-formed service name as a replacement for "wrs_registry".
		2341:  "xiostatus",            // XIO Status
		2342:  "manage-exec",          // Seagate Manage Exec
		2343:  "nati-logos",           // nati logos
		2344:  "fcmsys",               // fcmsys
		2345:  "dbm",                  // dbm
		2346:  "redstorm-join",        // Game Connection Port IANA assigned this well-formed service name as a replacement for "redstorm_join".
		2347:  "redstorm-find",        // Game Announcement and Location IANA assigned this well-formed service name as a replacement for "redstorm_find".
		2348:  "redstorm-info",        // Information to query for game status IANA assigned this well-formed service name as a replacement for "redstorm_info".
		2349:  "redstorm-diag",        // Diagnostics Port IANA assigned this well-formed service name as a replacement for "redstorm_diag".
		...
		2371:  "hp-rda",               // HP Remote Device Access
		...
		2395:  "lan900-remote",        // LAN900 Remote IANA assigned this well-formed service name as a replacement for "lan900_remote".
		2396:  "wusage",               // Wusage
		2397:  "ncl",                  // NCL
		...
		2445:  "dtn1",                 // DTN1
		2446:  "bues-service",         // bues_service IANA assigned this well-formed service name as a replacement for "bues_service".
		...
		2528:  "ncr-ccl",              // NCR CCL IANA assigned this well-formed service name as a replacement for "ncr_ccl".
		2529:  "utsftp",               // UTS FTP
		...
		2653:  "sonus",                // Sonus
		2654:  "corel-vncadmin",       // Corel VNC Admin IANA assigned this well-formed service name as a replacement for "corel_vncadmin".
		...
		2747:  "fjippol-swrly",        // fjippol-swrly
		2748:  "fjippol-polsvr",       // fjippol-polsvr
		2749:  "fjippol-cnsl",         // fjippol-cnsl
		2750:  "fjippol-port1",        // fjippol-port1
		2751:  "fjippol-port2",        // fjippol-port2
		...
		2916:  "elvin-server",         // Elvin Server IANA assigned this well-formed service name as a replacement for "elvin_server".
		2917:  "elvin-client",         // Elvin Client IANA assigned this well-formed service name as a replacement for "elvin_client".
		...
		3014:  "broker-service",       // Broker Service IANA assigned this well-formed service name as a replacement for "broker_service".
		3015:  "nati-dstp",            // NATI DSTP
		3016:  "notify-srvr",          // Notify Server IANA assigned this well-formed service name as a replacement for "notify_srvr".
		3017:  "event-listener",       // Event Listener IANA assigned this well-formed service name as a replacement for "event_listener".
		3018:  "srvc-registry",        // Service Registry IANA assigned this well-formed service name as a replacement for "srvc_registry".
		3019:  "resource-mgr",         // Resource Manager IANA assigned this well-formed service name as a replacement for "resource_mgr".
		3020:  "cifs",                 // CIFS
		3021:  "agriserver",           // AGRI Server
		3022:  "csregagent",           // CSREGAGENT
		3023:  "magicnotes",           // magicnotes
		3024:  "nds-sso",              // NDS_SSO IANA assigned this well-formed service name as a replacement for "nds_sso".
		3025:  "arepa-raft",           // Arepa Raft
		3026:  "agri-gateway",         // AGRI Gateway
		3027:  "liebdevmgmt-c",        // LiebDevMgmt_C IANA assigned this well-formed service name as a replacement for "LiebDevMgmt_C".
		3028:  "liebdevmgmt-dm",       // LiebDevMgmt_DM IANA assigned this well-formed service name as a replacement for "LiebDevMgmt_DM".
		3029:  "liebdevmgmt-a",        // LiebDevMgmt_A IANA assigned this well-formed service name as a replacement for "LiebDevMgmt_A".
		...
		3049:  "nsws",                 // NSWS
		3050:  "gds-db",               // gds_db IANA assigned this well-formed service name as a replacement for "gds_db".
		...
		3080:  "stm-pproc",            // stm_pproc IANA assigned this well-formed service name as a replacement for "stm_pproc".
		3081:  "tl1-lv",               // TL1-LV
		...
		3396:  "printer-agent",        // Printer Agent IANA assigned this well-formed service name as a replacement for "printer_agent".
		...
		3876:  "dl-agent",             // DirectoryLockdown Agent IANA assigned this well-formed service name as a replacement for "dl_agent".
		...
		3900:  "udt-os",               // Unidata UDT OS IANA assigned this well-formed service name as a replacement for "udt_os".
		...
		3938:  "dbcontrol-agent",      // Oracle dbControl Agent po IANA assigned this well-formed service name as a replacement for "dbcontrol_agent".
		...
		3986:  "mapper-ws-ethd",       // MAPPER workstation server IANA assigned this well-formed service name as a replacement for "mapper-ws_ethd".
		...
		4060:  "dsmeter-iatc",         // DSMETER Inter-Agent Transfer Channel IANA assigned this well-formed service name as a replacement for "dsmeter_iatc".
		...
		4065:  "avanti-cdp",           // Avanti Common Data IANA assigned this well-formed service name as a replacement for "avanti_cdp".
		...
		4132:  "nuts-dem",             // NUTS Daemon IANA assigned this well-formed service name as a replacement for "nuts_dem".
		4133:  "nuts-bootp",           // NUTS Bootp Server IANA assigned this well-formed service name as a replacement for "nuts_bootp".
		...
		4140:  "cedros-fds",           // Cedros Fraud Detection System IANA assigned this well-formed service name as a replacement for "cedros_fds".
		...
		4151:  "menandmice-noh",       // Men & Mice Remote Control IANA assigned this well-formed service name as a replacement for "menandmice_noh".
		4152:  "idig-mux",             // iDigTech Multiplex IANA assigned this well-formed service name as a replacement for "idig_mux".
		...
		4184:  "universe-suite",       // UNIVERSE SUITE MESSAGE SERVICE IANA assigned this well-formed service name as a replacement for "universe_suite".
		4185:  "wcpp",                 // Woven Control Plane Protocol
		4186:  "boxbackupstore",       // Box Backup Store Service
		4187:  "csc-proxy",            // Cascade Proxy IANA assigned this well-formed service name as a replacement for "csc_proxy".
		...
		4342:  "lisp-cons",            // LISP-CONS Control
		...
		4360:  "matrix-vnet",          // Matrix VNet Communication Protocol IANA assigned this well-formed service name as a replacement for "matrix_vnet".
		4368:  "wxbrief",              // WeatherBrief Direct
		4369:  "epmd",                 // Erlang Port Mapper Daemon
		4370:  "elpro-tunnel",         // ELPRO V2 Protocol Tunnel IANA assigned this well-formed service name as a replacement for "elpro_tunnel".
		...
		4420:  "nvm-express",          // NVM Express over Fabrics storage access
		...
		4846:  "contamac-icm",         // Contamac ICM Service IANA assigned this well-formed service name as a replacement for "contamac_icm".
		...
		4901:  "flr-agent",            // FileLocator Remote Search Agent IANA assigned this well-formed service name as a replacement for "flr_agent".
		...
		5000:  "commplex-main",        // commplex-main
		5001:  "commplex-link",        // commplex-link
		...
		5145:  "rmonitor-secure",      // RMONITOR SECURE IANA assigned this well-formed service name as a replacement for "rmonitor_secure".
		5146:  "social-alarm",         // Social Alarm Service
		5150:  "atmp",                 // Ascend Tunnel Management Protocol
		5151:  "esri-sde",             // ESRI SDE Instance IANA assigned this well-formed service name as a replacement for "esri_sde".
		...
		5165:  "ife-icorp",            // ife_1corp IANA assigned this well-formed service name as a replacement for "ife_icorp".
		...
		5565:  "hpe-dp-bura",          // HPE Advanced BURA
		...
		6301:  "bmc-ctd-ldap",         // BMC CONTROL-D LDAP SERVER IANA assigned this well-formed service name as a replacement for "bmc_ctd_ldap".
		...
		6444:  "sge-qmaster",          // Grid Engine Qmaster Service IANA assigned this well-formed service name as a replacement for "sge_qmaster".
		6445:  "sge-execd",            // Grid Engine Execution Service IANA assigned this well-formed service name as a replacement for "sge_execd".
		...
		6501:  "boks-servc",           // BoKS Servc IANA assigned this well-formed service name as a replacement for "boks_servc".
		6502:  "boks-servm",           // BoKS Servm IANA assigned this well-formed service name as a replacement for "boks_servm".
		6503:  "boks-clntd",           // BoKS Clntd IANA assigned this well-formed service name as a replacement for "boks_clntd".
		6505:  "badm-priv",            // BoKS Admin Private Port IANA assigned this well-formed service name as a replacement for "badm_priv".
		6506:  "badm-pub",             // BoKS Admin Public Port IANA assigned this well-formed service name as a replacement for "badm_pub".
		6507:  "bdir-priv",            // BoKS Dir Server, Private Port IANA assigned this well-formed service name as a replacement for "bdir_priv".
		6508:  "bdir-pub",             // BoKS Dir Server, Public Port IANA assigned this well-formed service name as a replacement for "bdir_pub".
		...
		6568:  "canit-store",          // CanIt Storage Manager IANA assigned this well-formed service name as a replacement for "canit_store".
		...
		6672:  "vision-server",        // vision_server IANA assigned this well-formed service name as a replacement for "vision_server".
		6673:  "vision-elmd",          // vision_elmd IANA assigned this well-formed service name as a replacement for "vision_elmd".
		...
		9616:  "erunbook-agent",       // eRunbook Agent IANA assigned this well-formed service name as a replacement for "erunbook_agent".
		9617:  "erunbook-server",      // eRunbook Server IANA assigned this well-formed service name as a replacement for "erunbook_server".
		...
		10003: "documentum-s",         // EMC-Documentum Content Server Product IANA assigned this well-formed service name as a replacement for "documentum_s".
		...
		20034: "nburn-id",             // NetBurner ID Port IANA assigned this well-formed service name as a replacement for "nburn_id".
		...
		24386: "intel-rci",            // Intel RCI IANA assigned this well-formed service name as a replacement for "intel_rci".
		...
		31620: "lm-mon",               // lm mon
		31685: "dsx-monitor",          // DS Expert Monitor IANA assigned this well-formed service name as a replacement for "dsx_monitor".
		31765: "gamesmith-port",       // GameSmith Port
		31948: "iceedcp-tx",           // Embedded Device Configuration Protocol TX IANA assigned this well-formed service name as a replacement for "iceedcp_tx".
		31949: "iceedcp-rx",           // Embedded Device Configuration Protocol RX IANA assigned this well-formed service name as a replacement for "iceedcp_rx".
		...
		44818: "ethernet-ip-2",        // EtherNet/IP messaging IANA assigned this well-formed service name as a replacement for "EtherNet/IP-2".
		...
		48048: "juliar",               // Juliar Programming Language Protocol
	...
	"udp": {
		...
		397:   "mptn",                 // Multi Protocol Trans. Net.
		398:   "kryptolan",            // Kryptolan
		399:   "iso-tsap-c2",          // ISO Transport Class 2 Non-Control over UDP
		400:   "osb-sd",               // Oracle Secure Backup
		401:   "ups",                  // Uninterruptible Power Supply
		402:   "genie",                // Genie Protocol
		403:   "decap",                // decap
		...
		772:   "cycleserv2",           // cycleserv2
		773:   "notify",               // notify
		774:   "acmaint-dbd",          //  IANA assigned this well-formed service name as a replacement for "acmaint_dbd".
		775:   "acmaint-transd",       //  IANA assigned this well-formed service name as a replacement for "acmaint_transd".
		776:   "wpages",               // wpages
		777:   "multiling-http",       // Multiling HTTP
		780:   "wpgs",                 // wpgs
		800:   "mdbs-daemon",          //  IANA assigned this well-formed service name as a replacement for "mdbs_daemon".
		...
		1526:  "pdap-np",              // Prospero Data Access Prot non-priv
		1527:  "tlisrv",               // oracle
		1528:  "ngr-t",                // NGR transport protocol for mobile ad-hoc networks
		1529:  "coauthor",             // oracle
		1530:  "rap-service",          // rap-service
		1531:  "rap-listen",           // rap-listen
		1532:  "miroconnect",          // miroconnect
		...
		2005:  "oracle",               // oracle
		2006:  "raid-cd",              // raid
		2007:  "raid-am",              // raid-am
		2008:  "terminaldb",           // terminaldb
		2009:  "whosockami",           // whosockami
		2010:  "pipe-server",          //  IANA assigned this well-formed service name as a replacement for "pipe_server".
		2011:  "servserv",             // servserv
		2012:  "raid-ac",              // raid-ac
		2013:  "raid-cd",              // raid-cd
		2014:  "raid-sf",              // raid-sf
		2015:  "raid-cs",              // raid-cs
		2016:  "bootserver",           // bootserver
		2017:  "bootclient",           // bootclient
		2018:  "rellpack",             // rellpack
		2019:  "about",                // about
		2020:  "xinupageserver",       // xinupageserver
		2021:  "xinuexpansion1",       // xinuexpansion1
		2022:  "xinuexpansion2",       // xinuexpansion2
		2023:  "xinuexpansion3",       // xinuexpansion3
		2024:  "xinuexpansion4",       // xinuexpansion4
		2025:  "xribs",                // xribs
		2026:  "scrabble",             // scrabble
		...
		2219:  "netiq-ncap",           // NetIQ NCAP Protocol
		2220:  "netiq",                // NetIQ End2End
		2221:  "ethernet-ip-s",        // EtherNet/IP over DTLS
		2222:  "ethernet-ip-1",        // EtherNet/IP I/O IANA assigned this well-formed service name as a replacement for "EtherNet/IP-1".
		2223:  "rockwell-csp2",        // Rockwell CSP2
		2224:  "efi-mg",               // Easy Flexible Internet/Multiplayer Games
		2226:  "di-drm",               // Digital Instinct DRM
		...
		2729:  "tcim-control",         // TCIM Control
		2730:  "nec-raidplus",         // NEC RaidPlus
		2731:  "fyre-messanger",       // Fyre Messagner
		2732:  "g5m",                  // G5M
		2733:  "signet-ctf",           // Signet CTF
		2734:  "ccs-software",         // CCS Software
		2735:  "netiq-mc",             // NetIQ Monitor Console
		...
		3695:  "bmc-data-coll",        // BMC Data Collection
		3696:  "telnetcpcd",           // Telnet Com Port Control
		3697:  "nw-license",           // NavisWorks Licnese System
		3698:  "sagectlpanel",         // SAGECTLPANEL
		3699:  "kpn-icw",              // Internet Call Waiting
		3700:  "lrs-paging",           // LRS NetPage
		3701:  "netcelera",            // NetCelera
		...
		3724:  "blizwow",              // World of Warcraft
		3725:  "na-er-tip",            // Netia NA-ER Port
		3726:  "array-manager",        // Xyartex Array Manager
		3727:  "e-mdu",                // Ericsson Mobile Data Unit
		3728:  "e-woa",                // Ericsson Web on Air
		3729:  "fksp-audit",           // Fireking Audit Port
		3730:  "client-ctrl",          // Client Control
		...
		3748:  "webdata",              // webData
		3749:  "cimtrak",              // CimTrak
		3750:  "cbos-ip-port",         // CBOS/IP ncapsalatoin port
		3751:  "gprs-cube",            // CommLinx GPRS Cube
		3752:  "vipremoteagent",       // Vigil-IP RemoteAgent
		3753:  "nattyserver",          // NattyServer Port
		3754:  "timestenbroker",       // TimesTen Broker Port
		...
		3847:  "msfw-control",         // MS Firewall Control
		3848:  "item",                 // IT Environmental Monitor
		3849:  "spw-dnspreload",       // SPACEWAY DNS Prelaod
		3850:  "qtms-bootstrap",       // QTMS Bootstrap Protocol
		3851:  "spectraport",          // SpectraTalk Port
		3852:  "sse-app-config",       // SSE App Configuration
		3853:  "sscan",                // SONY scanning protocol
		...
		3915:  "agcat",                // Auto-Graphics Cataloging
		3916:  "wysdmc",               // WysDM Controller
		3917:  "aftmux",               // AFT multiples port
		3918:  "pktcablemmcops",       // PacketCableMultimediaCOPS
		3919:  "hyperip",              // HyperIP
		3920:  "exasoftport1",         // Exasoft IP Port
		3921:  "herodotus-net",        // Herodotus Net
		...
		3936:  "mailprox",             // Mailprox
		3937:  "dvbservdsc",           // DVB Service Discovery
		3938:  "dbcontrol-agent",      // Oracel dbControl Agent po IANA assigned this well-formed service name as a replacement for "dbcontrol_agent".
		3939:  "aamp",                 // Anti-virus Application Management Port
		3940:  "xecp-node",            // XeCP Node Service
		3941:  "homeportal-web",       // Home Portal Web Server
		3942:  "srdp",                 // satellite distribution
		...
		4554:  "msfrs",                // MS FRS Replication
		4555:  "rsip",                 // RSIP Port
		4556:  "dtn-bundle",           // DTN Bundle UDP CL Protocol
		...
		5145:  "rmonitor-secure",      // RMONITOR SECURE IANA assigned this well-formed service name as a replacement for "rmonitor_secure".
		5150:  "atmp",                 // Ascend Tunnel Management Protocol
		5151:  "esri-sde",             // ESRI SDE Remote Start IANA assigned this well-formed service name as a replacement for "esri_sde".
		5152:  "sde-discovery",        // ESRI SDE Instance Discovery
		5154:  "bzflag",               // BZFlag game server
		5155:  "asctrl-agent",         // Oracle asControl Agent
		...
		11967: "sysinfo-sp",           // SysInfo Sercice Protocol
		12000: "entextxid",            // IBM Enterprise Extender SNA XID Exchange
		12001: "entextnetwk",          // IBM Enterprise Extender SNA COS Network Priority
		12002: "entexthigh",           // IBM Enterprise Extender SNA COS High Priority
		12003: "entextmed",            // IBM Enterprise Extender SNA COS Medium Priority
		...
		34378: "p-net-local",          // P-Net on IP local
		34379: "p-net-remote",         // P-Net on IP remote
		34567: "edi-service",          // dhanalakshmi.org EDI Service
		34962: "profinet-rt",          // PROFInet RT Unicast
		34963: "profinet-rtm",         // PROFInet RT Multicast
		34964: "profinet-cm",          // PROFInet Context Manager
		34980: "ethercat",             // EhterCAT Port
		35001: "rt-viewer",            // ReadyTech Viewer
		35004: "rt-classmanager",      // ReadyTech ClassManager
		35100: "axio-disc",            // Axiomatic discovery protocol
		...
		41111: "fs-qos",               // Foursticks QoS Protocol
		41230: "z-wave-s",             // Z-Wave Protocol over DTLS
		41794: "crestron-cip",         // Crestron Control Port
		41795: "crestron-ctp",         // Crestron Terminal Port
		42508: "candp",                // Computer Associates network discovery protocol
		42509: "candrp",               // CA discovery response
	...
	"sctp": {
		...
		0:     "dhanda-g",        // DHANDAg is going for a site
	},
	"dccp": {
		9:    "discard",       // Discard
		1021: "exp1",          // RFC3692-style Experiment 1
		1022: "exp2",          // RFC3692-style Experiment 2
		1113: "ltp-deepspace", // Licklider Transmission Protocol
		4556: "dtn-bundle",    // DTN Bundle DCCP CL Protocol
		5004: "avt-profile-1", // RTP media data
		5005: "avt-profile-2", // RTP control protocol
		6514: "syslog-tls",    // syslog over DTLS
		0:    "dccp-ping",     // ping/traceroute using DCCP
	},
}
